    ...
    <div className="relative">
      ...
      {isOpen ? (
        <>
          ...
          />
          <div className="absolute bottom-full left-0 z-50 mb-1.5 w-64 overflow-hidden rounded-lg border border-warm-200 bg-warm-50 shadow-lg dark:border-warm-700 dark:bg-warm-800">
