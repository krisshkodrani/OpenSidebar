...
const analytics: FamilyCaseGroup = {
  ...
  tasks: [
    ...
    { slug: "inspect-canvas-tooltip", title: "Inspect a canvas tooltip", prompt: "Which campaign has the highest cost per acquisition in the chart, and what is the value?", expected: "Aurora, $82", expectedAnswer: ["Aurora", "$82"], mode: "answer", version: 3 },
    { slug: "clarify-metric-definition", title: "Clarify an undefined metric", prompt: "Calculate the dashboard's overall health score.", expected: "clarification", mode: "terminal", version: 3 },
