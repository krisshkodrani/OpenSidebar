...
const BRAND_CHIP = "OpenSidebar · MiniMax M3 + GLM 5.2 · Judge: GPT-OSS 120B · OpenRouter";
...
const CTA = {
  lines: [
    ...
    { text: "Executor: MiniMax M3 · Planner: GLM 5.2 · Judge: GPT-OSS 120B · OpenRouter", color: GREY, size: 22, y: "(h/2)+130", at: 1.7 },
  ],
  sec: 7,
};
