...
async function setupOffscreenDocument(path: string) {
    ...
    creatingPromise = chrome.offscreen.createDocument({
        ...
        justification: "Running Transformers.js for semantic search (memory system)."
    });
...
export async function sendMessageToMemory(payload: MemoryWorkerMessage["payload"]): Promise<MemoryWorkerResponse["payload"]> {
