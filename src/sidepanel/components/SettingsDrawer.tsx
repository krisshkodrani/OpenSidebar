...
import { MODEL_EXECUTOR, MODEL_PLANNER, OPENAI_MODEL_EXECUTOR, OPENAI_MODEL_PLANNER, OPENAI_MODEL_PERCEPTION } from "../../background/llm/client";
            ...
            <>
              ...
              <section className="space-y-3">
                ...
                <select
                  ...
                  onChange={(e) =>
                    handleChange("provider", e.target.value as "openrouter" | "openai")
                  }
                  className="w-full px-3 py-2 text-sm border border-warm-300 dark:border-warm-700 rounded-md bg-warm-50 dark:bg-warm-900 focus:ring-2 focus:ring-primary-500 outline-none dark:text-warm-100"
                >
                ...
                {(formState.provider || "openrouter") === "openrouter" ? (
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-warm-400 dark:text-warm-500 mt-1">
                      Direct OpenAI API — same models, no routing overhead
                    </p>
                  </div>
                )}
              </section>
              ...
              <section className="space-y-2">
                ...
                <ModelSelector
                  ...
                  defaultModel={(formState.provider || "openrouter") === "openai" ? OPENAI_MODEL_EXECUTOR : MODEL_EXECUTOR}
                  models={models}
              ...
              <section className="space-y-2">
                ...
                <ModelSelector
                  ...
                  defaultModel={(formState.provider || "openrouter") === "openai" ? OPENAI_MODEL_PLANNER : MODEL_PLANNER}
                  models={models}
                  loading={modelsLoading}
                />
              </section>
              ...
              <section className="space-y-2">
                ...
                <ModelSelector
                  ...
                  defaultModel={(formState.provider || "openrouter") === "openai" ? OPENAI_MODEL_PERCEPTION : PERCEPTION_MODEL_DEFAULT}
                  models={models}
                  loading={modelsLoading}
                  filterVisionOnly
                />
