          ...
          <section className="space-y-3">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-warm-400 dark:text-warm-500">
                Second-priority provider when set
              </p>
              <input
                type="password"
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-warm-400 dark:text-warm-500">
                Highest priority provider when set
              </p>
              <input
                type="password"
          ...
          <section className="space-y-3">
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                onChange={(e) =>
                  handleChange("maxTurns", parseInt(e.target.value))
                }
            ...
            <div className="flex items-center justify-between">
              ...
              <select
                ...
                onChange={(e) =>
                  handleChange("contextWindowSize", parseInt(e.target.value))
                }
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-warm-400 dark:text-warm-500">
                  Show action plan and wait for approval before executing
                </p>
              </div>
              <input
                type="checkbox"
          ...
          <section className="space-y-3">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-warm-400 dark:text-warm-500">
                  Token usage, cost, and timing during agent runs
                </p>
              </div>
              <input
                type="checkbox"
          ...
          <section className="space-y-3">
            ...
            {formState.speechProvider === "groq" && !formState.groqApiKey && (
              <p className="text-xs text-amber-600 dark:text-amber-400">
                Groq API key required for Whisper. Set it above in API
                Configuration.
              </p>
            )}
          </section>
          ...
          <section className="space-y-3">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-warm-400 dark:text-warm-500">
                  Hide take_screenshot from tools (saves ~1-3s per call)
                </p>
              </div>
              <input
                type="checkbox"
                ...
                onChange={(e) =>
                  handleChange("disableScreenshot", e.target.checked)
                }
                className="w-4 h-4 text-primary-600 rounded bg-warm-100 border-warm-300 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-warm-800 focus:ring-2 dark:bg-warm-700 dark:border-warm-600"
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-warm-400 dark:text-warm-500">
                  Prevent agent from navigating to new URLs
                </p>
              </div>
              <input
                type="checkbox"
          ...
          <section className="space-y-3">
            ...
            <div className="flex items-center justify-between">
              ...
              <input
                ...
                onChange={(e) =>
                  handleChange("showElementTags", e.target.checked)
                }
                className="w-4 h-4 text-primary-600 rounded bg-warm-100 border-warm-300 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-warm-800 focus:ring-2 dark:bg-warm-700 dark:border-warm-600"
              />
            </div>
