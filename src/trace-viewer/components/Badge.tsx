...
const VARIANT_CLASSES: Record<string, string> = {
  ...
  model:
    "bg-teal-500/[0.12] text-trace-accent-light border border-teal-500/25 font-mono text-[9px] normal-case font-medium",
  manual:
  ...
  type: "bg-teal-500/[0.12] text-trace-accent-light border border-teal-500/25 normal-case",
  category:
  ...
  "role-user":
    "bg-teal-500/15 text-trace-accent-light border border-teal-500/30",
  ...
  "event-hint": "bg-teal-500/15 text-[#2dd4bf] border border-teal-500/30",
  "event-screenshot":
    "bg-green-500/15 text-[#2ecc71] border border-green-500/30",
  "event-plan_update":
