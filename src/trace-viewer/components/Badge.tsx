...
const VARIANT_CLASSES: Record<string, string> = {
  ...
  model:
    "bg-blue-500/[0.12] text-trace-accent-light border border-blue-500/25 font-mono text-[9px] normal-case font-medium",
  manual:
  ...
  "role-user":
    "bg-blue-500/15 text-trace-accent-light border border-blue-500/30",
